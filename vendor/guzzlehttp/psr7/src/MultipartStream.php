 ...
 */
class MultipartStream implements \_PhpScoper5c3efd0df2edb\Psr\Http\Message\StreamInterface
{
    ...
    {
        $stream = new \_PhpScoper5c3efd0df2edb\GuzzleHttp\Psr7\AppendStream();
    ...
    private function addElement(\_PhpScoper5c3efd0df2edb\GuzzleHttp\Psr7\AppendStream $stream, array $element)
    {
     ...
     * @return array
     */
    private function createElement($name, \_PhpScoper5c3efd0df2edb\Psr\Http\Message\StreamInterface $stream, $filename, array $headers)
    {
