...
use _PhpScoper5c3efd0df2edb\GuzzleHttp\ClientInterface;
use _PhpScoper5c3efd0df2edb\GuzzleHttp\Exception\GuzzleException;
use _PhpScoper5c3efd0df2edb\GuzzleHttp\Psr7\Request;
...
class MollieApiClient
{
     ...
     */
    public function __construct(\_PhpScoper5c3efd0df2edb\GuzzleHttp\ClientInterface $httpClient = null)
    {
        $this->httpClient = $httpClient ? $httpClient : new \_PhpScoper5c3efd0df2edb\GuzzleHttp\Client([\_PhpScoper5c3efd0df2edb\GuzzleHttp\RequestOptions::VERIFY => \_PhpScoper5c3efd0df2edb\Composer\CaBundle\CaBundle::getBundledCaBundlePath(), \_PhpScoper5c3efd0df2edb\GuzzleHttp\RequestOptions::TIMEOUT => self::TIMEOUT]);
        $compatibilityChecker = new \Mollie\Api\CompatibilityChecker();
        $compatibilityChecker->checkCompatibility();
        $this->initializeEndpoints();
        $this->addVersionString("Mollie/" . self::CLIENT_VERSION);
        $this->addVersionString("PHP/" . \phpversion());
        $this->addVersionString("Guzzle/" . \_PhpScoper5c3efd0df2edb\GuzzleHttp\ClientInterface::VERSION);
    }
    ...
    public function performHttpCallToFullUrl($httpMethod, $url, $httpBody = null)
    {
        ...
        $request = new \_PhpScoper5c3efd0df2edb\GuzzleHttp\Psr7\Request($httpMethod, $url, $headers, $httpBody);
        try {
            $response = $this->httpClient->send($request, ['http_errors' => \false]);
        } catch (\_PhpScoper5c3efd0df2edb\GuzzleHttp\Exception\GuzzleException $e) {
     ...
     * @throws ApiException
     */
    private function parseResponseBody(\_PhpScoper5c3efd0df2edb\Psr\Http\Message\ResponseInterface $response)
    {
